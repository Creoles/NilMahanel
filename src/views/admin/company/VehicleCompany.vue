    ...
    <el-dialog title="收款账号"
      ...
      <div>
        <el-table :data="accountList" v-on:header-click="addLine">
          ...
          <el-table-column label="货币类型">
            <template scope="scope">
              <el-select v-model="scope.row.currency" size="small">
                ...
                <el-option :value="2" label="斯里兰卡卢布"></el-option>
              </el-select>
            </template>
          </el-table-column>
          ...
          <el-table-column label="操作">
            <template scope="scope">
              <el-button size="small" @click="saveAccount(scope.row.id)">保存</el-button>
              <el-button size="small" @click="saveAccount(scope.row.id)">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
