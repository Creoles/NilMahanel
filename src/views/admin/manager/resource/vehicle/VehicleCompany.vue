  ...
  <div>
    ...
    <el-table :data="vehicleCompanyList"
          ...
          <el-popover ref="account"
            ...
            <el-table :data="compAccountList">
              <el-table-column property="currency"
                               label="币种"
                               :formatter="currencyFormatter"></el-table-column>
              <el-table-column property="bank_name"
                               label="银行名称"></el-table-column>
              <el-table-column property="deposit_bank"
                               label="开户支行"></el-table-column>
              <el-table-column property="payee"
                               label="收款人名称"></el-table-column>
              <el-table-column property="account"
                               label="收款人账号"></el-table-column>
              <el-table-column property="note"
                               label="备注"></el-table-column>
              <el-table-column>
                <template scope="scope">
                  <el-button type="text"
                             @click="openEditCompAccount(scope.row)">编辑</el-button>
                  <el-button type="text"
                             @click="deleteCompAccount(scope.row.id)">删除</el-button>
                </template>
              </el-table-column>
            </el-table>
          </el-popover>
      ...
      <el-table-column label="操作">
        <template scope="scope">
          <el-button type="text"
                     @click="editVehicleCompany(scope.row)">编辑</el-button>
          <el-button type="text"
                     @click="openOneCompAccount(scope.row.id)">添加收款账号</el-button>
          <el-button type="text"
                     @click="deleteVehicleCompany(scope)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-dialog :title="vehicleCompanyModel.id?'编辑集团':'添加集团'"
      ...
      <div slot="footer"
        ...
        <el-button type="primary"
                   @click="addVehicleCompany">确 定</el-button>
      </div>
    </el-dialog>
