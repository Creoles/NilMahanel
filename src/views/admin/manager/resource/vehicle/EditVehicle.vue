<template>
    <div>
        ...
        <el-form :model="params" :inline="true" :rules="rule" label-position="top" class="vehicle-form" ref="vehicleForm">
            ...
            <el-form-item label="所属车辆公司">
                <el-select clearable v-model="params.company_id">
            ...
            <el-form-item label="车牌号" prop="ID" class="width-class">
                <el-input v-model="params.license"></el-input>
            </el-form-item>
            <el-form-item label="座位数" prop="set" class="width-class">
                <el-input v-model="params.seat"></el-input>
            </el-form-item>
            <el-form-item label="年限" prop="year" class="width-class">
                <el-input v-model="params.start_use"></el-input>
            </el-form-item>
            <el-form-item label="保险号" prop="baoxian" class="width-class">
                <el-input v-model="params.year"></el-input>
            </el-form-item>
            <el-form-item label="旅游局登记号" prop="dengji" class="width-class">
                <el-input v-model="params.register_number"></el-input>
            </el-form-item>
            <el-form-item label="联系人" prop="people" class="width-class">
                <el-input v-model="params.contact"></el-input>
            </el-form-item>
            <el-form-item label="预定电话" prop="phone" class="width-class">
                <el-input v-model="params.telephone"></el-input>
            </el-form-item>
            <el-form-item label="价格/每公里(USD)" class="width-class" prop="price">
                <el-input v-model="params.unit_price"></el-input>
            </el-form-item>
        </el-form>
        <el-button type="primary" v-if="!submitting" @click="submit('vehicleForm')">提 交</el-button>
