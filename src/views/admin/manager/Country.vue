<template>
    <div>
        <content-top><el-button class="addCountry" @click="dialogCountry = true" type="primary">添加国家</el-button></content-top>
        <el-collapse accordion>
          <el-collapse-item v-for="item in countryList" :key="item.id">
            <template slot="title">
        ...
        <el-dialog title="添加国家" v-model="dialogCountry" size="tiny">
          <el-form :model="countryModel">
            <el-form-item label="中文名称">
              <el-input v-model="countryModel.name" auto-complete="off"></el-input>
            </el-form-item>
            <el-form-item label="英文名称">
              <el-input v-model="countryModel.name_en" auto-complete="off"></el-input>
            </el-form-item>
          </el-form>
        ...
        <el-dialog title="添加城市" v-model="dialogCity" size="tiny">
          <el-form :model="cityModel">
            <el-form-item label="中文名称">
              <el-input v-model="cityModel.name" auto-complete="off"></el-input>
            </el-form-item>
            <el-form-item label="英文名称">
              <el-input v-model="cityModel.name_en" auto-complete="off"></el-input>
            </el-form-item>
          </el-form>
          <div slot="footer" class="dialog-footer">
...
<script>
    ...
    export default{
        data(){
            return{
              countryList:[{id:1, name: '斯里兰卡',name_en:'Srilanka',city_data:[
